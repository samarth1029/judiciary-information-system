...
class Register:
    def __init__(self, root):
        ...
        self.user_entry.place(x=20, y=110)

        contact_lbl = Label(main_frame,
                            text="Contact No",
                            font=("lucida handwriting", 10, "bold"),
                            bg='lightblue')
        ...
        search_label = Label(main_frame,
                             text="Select Security Question",
                             font=("lucida handwriting", 10, "bold"),
                             bg='lightblue')
        search_label.place(x=20, y=190)
        search_combo = ttk.Combobox(main_frame,
        ...
        pass_lbl = Label(main_frame,
                         text="Password",
                         font=("lucida handwriting", 10, "bold"),
                         bg='lightblue')
        pass_lbl.place(x=20, y=250)
        self.pass_entry = ttk.Entry(main_frame,
        ...
        lname_lbl = Label(main_frame,
                          text="Last Name",
                          font=("lucida handwriting", 10, "bold"),
                          bg='lightblue')
        lname_lbl.place(x=350, y=90)
        self.luser_entry = ttk.Entry(main_frame,
                                     textvariable=self.var_lname,
                                     width=37,
                                     font=("times new roman", 10,))
        self.luser_entry.place(x=350, y=110)

        email_lbl = Label(main_frame,
                          text="Username",
                          font=("lucida handwriting", 10, "bold"),
                          bg='lightblue')
        ...
        checkbtn2 = ttk.Checkbutton(main_frame,
                                    variable=self.var_check,
                                    offvalue=0,
                                    onvalue=1)
        checkbtn2.place(x=20, y=310)
        checkbtn2_label = Label(main_frame,
                                text="I agree to the terms and conditions",
                                font=("times new roman", 12),
                                bg="lightblue")
        checkbtn2_label.place(x=40, y=310)

        img2 = Image.open(r"C:\BI\Projects\judiciary-information-system\src\data\images\reg.jpg")
        ...
        img3 = Image.open(r"C:\BI\Projects\judiciary-information-system\src\data\images\login.jpg")
        img3 = img3.resize((150, 30), Image.ANTIALIAS)
        self.photoimg3 = ImageTk.PhotoImage(img3)
        b3 = Button(main_frame,
